...
<Note>
  This workflow differs from [Controller Screen Capture](/alpharelay/companion-capture-mode) on an Android drone controller. Avata 2 uses DJI Fly on a separate Android device instead of a native flight app on an Android drone controller.
</Note>
