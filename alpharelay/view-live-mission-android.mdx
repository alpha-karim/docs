...
description: "Watch remote live, follow timeline updates, and log events from a second licensed Operator device."
...
→ [Use AlphaRelay Operator on iPhone or iPad](/alpharelay/ios-copilot) · [Watch in Mission Overwatch](/alpharelay/watch-in-mission-overwatch) · [Log events](/alpharelay/event-logging)
