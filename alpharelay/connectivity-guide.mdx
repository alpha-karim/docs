---
title: "Connectivity"
description: "Local Network viewing vs internet sync and queued uploads."
...
<Warning>
  Internet sync and local relay viewing are different paths. Local Network viewing needs same-network reachability, not cloud access.
</Warning>
