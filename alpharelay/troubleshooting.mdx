...
3. If **Tablet IP (LAN)** is blank, click **Connect** to scan the LAN.
4. If discovery fails or the saved address is wrong, enter the IPv4 address shown on the pilot tablet as a fallback.
...
- Open **Pilot console** or **Controls** → **Local AI** and confirm detection is enabled.
