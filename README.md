...
- **Home** — `index.mdx`
- **Start Here** — plain English intro, workflow overview, roles, mission types, Controller Screen Capture and Pilot mode, Avata 2 with Goggles 3, training exercise
